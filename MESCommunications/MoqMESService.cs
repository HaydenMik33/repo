...
namespace MESCommunications
{
    public class MoqMESService : IMESService
    {
        ...
        private Mock<IMESService> CreateOperatorRepository()
        {
            ...
            repo.Setup(r => r.ValidateEmployee("Cindy.Smith")).Returns(AuthorizationLevel.Operator);
            repo.Setup(r => r.ValidateEmployee("zahir.haque")).Returns(AuthorizationLevel.Administrator);
            repo.Setup(r => r.ValidateEmployee("Mike.Smith")).Returns(AuthorizationLevel.Engineer);
            return repo;
        }
        ...
        public AuthorizationLevel ValidateEmployee(string strEmployeeName)
        {
            ...
            AuthorizationLevel authLvl = AuthorizationLevel.InvalidUser;
            authLvl = repo.Object.ValidateEmployee(strEmployeeName);
            return authLvl;
        }
